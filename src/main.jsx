        ...
        `}>
          ...
          <input
            ...
            className={`
              ...
              focus:outline-none
              /* 移动端使用 text-base (16px) 防止iOS缩放，电脑端保持 text-sm */
...
const ResultBox = ({ label, value, subtext, highlightColor = "text-slate-800", isNegativeRed = false, isLast = false, border = true }) => {
  ...
  return (
    <div className={`flex flex-col px-3 py-3 lg:px-4 lg:py-4 flex-1 min-w-[85px] justify-center relative ${border && !isLast ? 'border-r border-slate-100' : ''}`}>
  ...
  return (
    <div className="min-h-screen bg-[#F2F3F5] text-slate-900 font-sans p-4 lg:p-8 transition-colors duration-300">
      ...
      <div className="max-w-[1600px] mx-auto h-full flex flex-col">
        ...
        {/* 核心布局：Grid System - 移动端单列(gap-4)，电脑端三列(lg:gap-6) */}
